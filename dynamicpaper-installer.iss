...
#define MyAppURL "https://github.com/Maxstupo/DynamicPaper"
#define MyAppExeName "DynamicPaper.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{5D418F6D-FDA4-42BF-B3B7-A676C7F6A28E}
AppName={#MyAppName}
...
OutputDir=.
OutputBaseFilename=DynamicPaper-Setup_v{#ApplicationVersion}
SetupIconFile=DynamicPaper\DynamicPaper.ico
Compression=lzma
